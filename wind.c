...
winsettag1(Window *w)
{
	...
	static Rune Lan[] = { ' ', '"', 'a', 'n', ' ', '"', ' ', 0 };
	static Rune Lpipe[] = { ' ', '|', 0 };
	static Rune Lwin[] = { 'w', 'i', 'n', 0 };
	static Rune Lgk[] = { ' ', 'g', 'k', 0 };
	static Rune Lnb[] = { ' ', '"', 'n', 'b', 's', ' ', '"', 0 };
	static Rune Ledit[] = { ' ', '"', 'S', ' ', '"', 0 };
	static Rune Lxplor[] = { ' ', 'x', 'p', 0 };
	static Rune Lgg[] = { ' ', '"', 'g', 'g', ' ', '"', ' ', 0 };
	static Rune Lmk[] = { 'm', 'k', ' ', 0 };
	static Rune Ljli[] = { '|', 'j', 'l', 'i', ' ', 0 };
	static Rune Lpc[] = { 'p', 'c', ' ', 0 };
	static Rune Lrect[] = {'"', 'r', ' ', '"', ' ', 0 };
	static Rune Lall[] = {'A', ' ', 0 };
	static Rune Laplus[] = {'|', 'a', '+', ' ', 0};
	static Rune Laminus[] = {'|', 'a', '-', ' ', 0};
	static Rune Lb[] = {'"', 'b', ' ', '"', ' ', 0};
	static Rune Lab[] = {'|', 'a', 'b', ' ', 0};
	static Rune Lco[] = {'|', 'c', 'o', ' ', 0};
	static Rune Luz[] = {'u', 'z', ' ', 0};
	static Rune Lpar[] = {'|', 'p', 'a', 'r', ' ', 0};
	static Rune Lago[] = {'a', 'g', 'o', ' ', 0};
...
//	}
	...
	if(r)
		...
		if(w->body.file->seq == 0){
			runemove(new+i, Lan, 7);
			i += 7;
			runemove(new+i, Lwin, 3);
			i += 3;
			runemove(new+i, Lgk, 3);
			i += 3;
			runemove(new+i, Lnb, 7);
			i += 7;
			runemove(new+i, Ledit, 5);
			i += 5;
			runemove(new+i, Lxplor, 3);
			i += 3;
			runemove(new+i, Lgg, 7);
			i += 7;
			runemove(new+i, Lmk, 3);
			i += 3;
			runemove(new+i, Ljli, 5);
			i += 5;
			runemove(new+i, Lpc, 3);
			i += 3;
			runemove(new+i, Lrect, 5);
			i += 5;
			runemove(new+i, Lall, 2);
			i += 2;
			runemove(new+i, Laplus, 4);
			i += 4;
			runemove(new+i, Laminus, 4);
			i += 4;
			runemove(new+i, Lb, 5);
			i += 5;
			runemove(new+i, Lab, 4);
			i += 4;
			runemove(new+i, Lco, 4);
			i += 4;
			runemove(new+i, Luz, 3);
			i += 3;
			runemove(new+i, Lpar, 5);
			i += 5;
			runemove(new+i, Lago, 4);
			i += 4;
		}
	}
	new[i] = 0;
